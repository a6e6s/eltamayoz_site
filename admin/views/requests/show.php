...
if (!isset($id) || empty($id) || !is_numeric($id)) {
    ...
    $model->redirect_to(ADMIN_URL . 'requests/items');
} else {
    // get item details ...........
    $item = $model->Get('requests', '*', " WHERE id = '" . $id . "' ");
    if (!is_array($item)) {
        $session->message('sorry .. This page Not Found .', 'alert alert-danger');
        $model->redirect_to(ADMIN_URL . 'requests/items');
    } else {
        ...
        $_service = (isset($item[0]['service'])) ? $item[0]['service'] : '';
    ...
    $change_readable = $model->NewUpdate('requests', $read, " WHERE id = '" . $id . "' ");
}
?>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href="<?php echo ADMIN_URL; ?>requests">Requests</a></li>
                    <li class="active">Message</li>
                </ul><!-- /.breadcrumb -->
            </div>
            <div class="page-content">
                <div class="page-header">
                    <h1> Requests <small> <i class="ace-icon fa fa-angle-double-right"></i> <?php echo 'Message From  ' . $_name; ?> </small></h1>
                </div><!-- /.page-header -->
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        ...
                        <div class="col-xs-12 col-sm-2 clearfix">
                            <a class="btn  btn-danger col-xs-12" for="submit" href="<?php echo ADMIN_URL; ?>requests">Back</a>
