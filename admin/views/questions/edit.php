            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <?php require ADMIN_PATH . DS . 'models/edit_questions_model.php'; ?>
                        <form class="form-horizontal" action="#" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12 col-sm-10">
                                    <input type="text" name="alias" id="form-field-1" placeholder="" class="col-xs-12 col-sm-5" value="<?php echo $_alias; ?>" />
                                </div>
                            </div>
                            <div class="form-group">
