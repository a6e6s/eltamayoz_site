        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    ...
                    <a href="<?php echo ADMIN_URL; ?>questions/new_item" class="btn btn-success col-xs-12 col-sm-2 btn-sm">New </a>
                            ...
                            <tbody>
                                ...
                                if (is_array($items)) {
                                    foreach ($items as $item) {
                                        ...
                                        $count_examiness = $model->Count_Rows('examinees', " WHERE question_id = '".$_id."' ");
                                        ?>
                                        <tr>
                                            <td class="center">
                                                <label class="pos-rel">
                                            ...
                                            <td>
                                                <a href="<?php echo ADMIN_URL . 'questions/edit_item/' . $item['id']; ?>"><?php echo $title; ?></a>
                                            ...
                                            <td class="center"><a href="<?php echo ADMIN_URL . 'questions/examinees/' . $item['id']; ?>"><?php echo $count_examiness.' Examinees ';  ?> </a></td>
                                            <td class="center">
                                                <div class="action-buttons">
                                                    ...
                                                    <a href="<?php echo ADMIN_URL . 'questions/edit_item/' . $item['id']; ?>" data-rel="tooltip" data-placement="top" title="Edit">
...
//    actions ........
                                                function action(anchor) {
                                                    ...
                                                    if (action == 'delete')
                                                    {
                                                        ...
                                                        if (x == true)
                                                        {
                                                            $.get("<?php echo ADMIN_URL ?>views/questions/action.php?status=1&action=" + action + "&id=" + id, function (dd) {
                                                                location.reload();
                                                            });
                                                        }
                                                    } else
                                                    ...
                                                    $('.action').click(function () {
                                                        ...
                                                        } else
                                                        {
                                                            if (action == 'delete')
                                                            {
                                                                ...
                                                                if (x == true)
                                                                {
                                                                    $.get("<?php echo ADMIN_URL ?>views/questions/action.php?action=" + action + "&id=" + id, function (dd) {
                                                                        location.reload();
                                                                    });
                                                                }
                                                            } else
