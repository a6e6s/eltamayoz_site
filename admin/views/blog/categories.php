 ...
 */
$model = new model();
$items = $model->Get_Multilevel('categories', 'id,name,status,level,created,modified');
?>
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    ...
                    <a href="<?php echo ADMIN_URL; ?>blog/new_category" class="btn btn-success col-xs-12 col-sm-2 btn-sm">New </a>
                        ...
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th width="80%">Name</th>
                                    <th class="center" width="5%">Level</th>
                            ...
                            <tbody>
                                ...
                                if (is_array($items)) {
                                    foreach ($items as $item) {
                                        $title_array = (isset($item['name'])) ? unserialize(base64_decode($item['name'])) : array();
                                        $title = (is_array($title_array)) ? $title_array['en'] : '';
                                        $summary_title = $model->Cut_Words($title, 0, 55, 'yes');
                                        $_level = (isset($item['level'])) ? $item['level'] : 0;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo str_repeat(' _ ', ($_level) - 1) . ' '; ?>
                                                <a href="<?php echo ADMIN_URL . 'blog/edit_category/' . $item['id']; ?>"><?php echo $summary_title; ?></a>
                                            ...
                                            <td class="center" width="5%"><?php echo $_level; ?></td>
                                            <td class="center">
                                                <div class="action-buttons">
                                                    ...
                                                    <a href="<?php echo ADMIN_URL . 'blog/edit_category/' . $item['id']; ?>" data-rel="tooltip" data-placement="top" title="Edit">
...
<script type="text/javascript">
                                                        ...
                                                        function action(anchor) {
                                                            ...
                                                            if (action == 'delete')
                                                            {
                                                                ...
                                                                if (x == true)
                                                                {
                                                                    $.get("<?php echo ADMIN_URL ?>views/blog/categories_action.php?status=1&action=" + action + "&id=" + id, function(dd) {
                                                                        location.reload();
                                                                    });
                                                                }
                                                            } else
                                                            ...
                                                            $('.action').click(function() {
                                                                ...
                                                                } else
                                                                {
                                                                    if (action == 'delete')
                                                                    {
                                                                        ...
                                                                        if (x == true)
                                                                        {
                                                                            $.get("<?php echo ADMIN_URL ?>views/blog/categories_action.php?action=" + action + "&id=" + id, function(dd) {
                                                                                location.reload();
                                                                            });
                                                                        }
                                                                    } else
