        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    <h1> Blog <small> <i class="ace-icon fa fa-angle-double-right"></i> Create New Category </small></h1>
                </div><!-- /.page-header -->
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <link rel="stylesheet" href="<?php echo ADMIN_URL; ?>templates/css/chosen.min.css" />
                        <?php require ADMIN_PATH . DS . 'models/new_category_model.php'; ?>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            foreach ($languages as $lang) {
                                                ...
                                                <div id="<?php echo $lang['alias']; ?>" class="tab-pane fade in <?php echo ($num == 1) ? 'active' : null; ?>">
                                                    <input type="text" name="title_<?php echo $lang['alias']; ?>" id="form-field-1" placeholder="Category Name" class="col-xs-12 col-sm-5" />
                                    ...
                                    <select name="parent_id" class="chosen-select form-control" id="form-field-select-3" data-placeholder="Choose Category ...">
                                        ...
                                        if (is_array($categories)) {
                                            foreach ($categories as $category) {
                                                ...
                                                ?>
                                                <option value="<?php echo $_category_id . ',' . $_category_level; ?>" ><?php echo str_repeat(' - ', $_category_level - 1) . ' ' . $_category_name; ?></option>
                                                <?php
                                            }
                                        }
                                        ?>
