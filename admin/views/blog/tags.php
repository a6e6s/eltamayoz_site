 ...
 */
$model = new model();
$items = $model->Get('articles_tags', 'id,name,status,created,modified');
?>
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    ...
                    <a href="<?php echo ADMIN_URL; ?>blog/new_tag" class="btn btn-success col-xs-12 col-sm-2 btn-sm">New </a>
                            ...
                            <tbody>
                                ...
                                if (is_array($items)) {
                                    foreach ($items as $item) {
                                        $title_array = (isset($item['name'])) ? unserialize($item['name']) : array();
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo ADMIN_URL . 'blog/edit_tag/' . $item['id']; ?>"><?php echo $summary_title; ?></a>
                                            ...
                                            <td class="center">
                                                <div class="action-buttons">
                                                    ...
                                                    <a href="<?php echo ADMIN_URL . 'blog/edit_tag/' . $item['id']; ?>" data-rel="tooltip" data-placement="top" title="Edit">
...
<script type="text/javascript">
                                                        ...
                                                        function action(anchor) {
                                                            ...
                                                            if (action == 'delete')
                                                            {
                                                                ...
                                                                if (x == true)
                                                                {
                                                                    $.get("<?php echo ADMIN_URL ?>views/blog/tag_action.php?status=1&action=" + action + "&id=" + id, function(dd) {
                                                                        location.reload();
                                                                    });
                                                                }
                                                            } else
                                                            ...
                                                            $('.action').click(function() {
                                                                ...
                                                                } else
                                                                {
                                                                    if (action == 'delete')
                                                                    {
                                                                        ...
                                                                        if (x == true)
                                                                        {
                                                                            $.get("<?php echo ADMIN_URL ?>views/blog/tag_action.php?action=" + action + "&id=" + id, function(dd) {
                                                                                location.reload();
                                                                            });
                                                                        }
                                                                    } else
