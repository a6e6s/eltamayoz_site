        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    <h1 class="col-xs-12 col-sm-10"> Messages
                        <small>
                                ...
                                if (is_array($items)) {
                                    foreach ($items as $item) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo ADMIN_URL . 'messages/show/' . $message_id; ?>" <?php echo ($readable == 0) ? 'class="orange"' : null; ?> ><?php echo $name; ?></a>
                                                <br/><small class="grey"><strong>Time:</strong> <?php echo $_created; ?></small>
                                            </td>
                                            <td class="center" width="10%"> <?php echo $email; ?></td>
                                            <td class="center" width="10%"> <?php echo $phone; ?></td>
                                            <td class="center">
                                                <div class="action-buttons">
                                                    ...
                                                    <a href="<?php echo ADMIN_URL . 'messages/show/' . $message_id; ?>" data-rel="tooltip" data-placement="top" title="Show">
...
<script type="text/javascript">
                                                        ...
                                                        function action(anchor) {
                                                            ...
                                                            if (action == 'delete')
                                                            {
                                                                ...
                                                                if (x == true)
                                                                {
                                                                    $.get("<?php echo ADMIN_URL ?>views/messages/action.php?status=1&action=" + action + "&id=" + id, function(dd) {
                                                                        location.reload();
                                                                    });
                                                                }
                                                            } else
                                                            ...
                                                            $('.action').click(function() {
                                                                ...
                                                                } else
                                                                {
                                                                    if (action == 'delete')
                                                                    {
                                                                        ...
                                                                        if (x == true)
                                                                        {
                                                                            $.get("<?php echo ADMIN_URL ?>views/messages/action.php?action=" + action + "&id=" + id, function(dd) {
                                                                                location.reload();
                                                                            });
                                                                        }
                                                                    } else
