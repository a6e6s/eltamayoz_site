 ...
 */
$model = new model();
$items = $model->Get('works', 'id,title,image,status');
?>
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    ...
                    <a href="<?php echo ADMIN_URL; ?>works/new_item" class="btn btn-success col-xs-12 col-sm-2 btn-sm">New </a>
                        ...
                        if (is_array($items)) {
                            ...
                            <ul class="ace-thumbnails clearfix">
                                ...
                                foreach ($items as $item) {
                                    ...
                                    $selected = "works_tags.id,works_tags.name,works_relation_tags.tag_id";
                                    $where = " WHERE works_relation_tags.work_id = '" . $item['id'] . "' AND works_relation_tags.tag_id = works_tags.id";
                                    $tags = $model->Get('works_tags,works_relation_tags', $selected, $where,'id', 'DESC','0','6');
                                    ?>
                                    <li class="col-xs-12 col-sm-3">
                                        <a href="<?php echo URL . 'images/files/works/' . $item['image']; ?>" data-rel="colorbox" class="col-xs-12">
                                            <img alt="<?php echo $title; ?>" src="<?php echo URL. 'images/files/works/' . $item['image']; ?>" />
                                        </a>
                                        <div class="tags">
                                            <?php
                                            if (is_array($tags)) {
                                                foreach ($tags as $tag) {
                                                    ...
                                                    <span class="label-holder">
                                                        <a href="<?php echo ADMIN_URL.'works/edit_tag/'.$tag['id']; ?>" class="label label-info arrowed"><?php echo $summary_tag_title; ?></a>
                                                    </span>
                                                    <?php
                                                }
                                            }
                                        ...
                                        <div class="col-xs-12 title">
                                            ...
                                            <div class="tools tools-top">
                                                ...
                                                <a href="<?php echo ADMIN_URL . 'works/edit_item/' . $item['id']; ?>" data-rel="tooltip" data-placement="bottom" title="Edit">
...
//    actions ........
                                                    function action(anchor) {
                                                        ...
                                                        if (action == 'delete')
                                                        {
                                                            ...
                                                            if (x == true)
                                                            {
                                                                $.get("<?php echo ADMIN_URL ?>views/works/action.php?status=1&action=" + action + "&id=" + id, function(dd) {
                                                                    location.reload();
                                                                });
                                                            }
                                                        } else
                                                        ...
                                                        $('.action').click(function() {
                                                            ...
                                                            } else
                                                            {
                                                                if (action == 'delete')
                                                                {
                                                                    ...
                                                                    if (x == true)
                                                                    {
                                                                        $.get("<?php echo ADMIN_URL ?>views/works/action.php?action=" + action + "&id=" + id, function(dd) {
                                                                            location.reload();
                                                                        });
                                                                    }
                                                                } else
