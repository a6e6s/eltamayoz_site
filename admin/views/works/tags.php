 ...
 */
$model = new model();
$select = ' works_tags.id,works_tags.name as tag_name,works_tags.status,works_tags.site_id,works_tags.created,works_tags.modified,sites.name as site_name ';
$where = ' WHERE works_tags.site_id = sites.id ';
$items = $model->Get('works_tags,sites', $select, $where);
?>
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    <h1 class="col-xs-12 col-sm-10"> Works
                        <small>
                            <i class="ace-icon fa fa-angle-double-right"></i>
                            List of Works Tags
                        </small>
                    </h1>
                    <a href="<?php echo ADMIN_URL; ?>works/new_tag" class="btn btn-success col-xs-12 col-sm-2 btn-sm">New </a>
                            ...
                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="70%">Name</th>
                                        <th width="15%" class="center">Site</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($items as $item) {
                                        $tag_title_array = (isset($item['tag_name'])) ? unserialize($item['tag_name']) : array();
                                        $tag_title = (is_array($tag_title_array)) ? $tag_title_array['en'] : '';
                                        $summary_tag_title = $model->Cut_Words($tag_title, 0, 55, 'yes');
                                        $site_title_array = (isset($item['site_name'])) ? unserialize(base64_decode($item['site_name'])) : array();
                                        $site_title = (is_array($site_title_array)) ? $site_title_array['site_name_en'] : '';
                                        $summary_site_title = $model->Cut_Words($site_title, 0, 55, 'yes');
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo ADMIN_URL . 'works/edit_tag/' . $item['id']; ?>" title="<?php echo $tag_title; ?>"><?php echo $summary_tag_title; ?></a>
                                            ...
                                            <td class="center">
                                                <a href="<?php echo ADMIN_URL . 'sites/edit_item/' . $item['site_id']; ?>" title="<?php echo $site_title; ?>"><?php echo $summary_site_title; ?></a>
                                            </td>
                                            <td class="center">
                                                <div class="action-buttons">
                                                    ...
                                                    <a href="<?php echo ADMIN_URL . 'works/edit_tag/' . $item['id']; ?>" data-rel="tooltip" data-placement="top" title="Edit">
...
<script type="text/javascript">
                                                        ...
                                                        function action(anchor) {
                                                            ...
                                                            if (action == 'delete')
                                                            {
                                                                ...
                                                                if (x == true)
                                                                {
                                                                    $.get("<?php echo ADMIN_URL ?>views/works/tag_action.php?status=1&action=" + action + "&id=" + id, function (dd) {
                                                                        location.reload();
                                                                    });
                                                                }
                                                            } else
                                                            ...
                                                            $('.action').click(function () {
                                                                ...
                                                                } else
                                                                {
                                                                    if (action == 'delete')
                                                                    {
                                                                        ...
                                                                        if (x == true)
                                                                        {
                                                                            $.get("<?php echo ADMIN_URL ?>views/works/tag_action.php?action=" + action + "&id=" + id, function (dd) {
                                                                                location.reload();
                                                                            });
                                                                        }
                                                                    } else
