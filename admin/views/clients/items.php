 ...
 */
$model = new model();
$items = $model->Get('clients', 'id,title,image,status');
?>
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    ...
                    <a href="<?php echo ADMIN_URL; ?>clients/new_item" class="btn btn-success col-xs-12 col-sm-2 btn-sm">New </a>
                        ...
                        if (is_array($items)) {
                            ...
                            <ul class="ace-thumbnails clearfix">
                                ...
                                foreach ($items as $item) {
                                    $title_array = (isset($item['title'])) ? unserialize($item['title']) : '';
                                    $title = (is_array($title_array)) ? $title_array['en'] : '';
                                    $summary_title = $model->Cut_Words($title, 0, 35, 'yes');
                                    $selected = "clients_tags.id,clients_tags.name,clients_relation_tags.tag_id";
                                    $where = " WHERE clients_relation_tags.work_id = '" . $item['id'] . "' AND clients_relation_tags.tag_id = clients_tags.id";
                                    $tags = $model->Get('clients_tags,clients_relation_tags', $selected, $where,'id', 'DESC','0','6');
                                    ?>
                                    <li class="col-xs-12 col-sm-3">
                                        <a href="<?php echo URL . 'images/files/clients/' . $item['image']; ?>" data-rel="colorbox" class="col-xs-12">
                                            <img alt="<?php echo $title; ?>" src="<?php echo URL . 'images/files/clients/' . $item['image']; ?>" />
                                        </a>
                                        <div class="tags">
                                            <?php
                                            if (is_array($tags)) {
                                                foreach ($tags as $tag) {
                                                    ...
                                                    <span class="label-holder">
                                                        <a href="<?php echo ADMIN_URL.'clients/edit_tag/'.$tag['id']; ?>" class="label label-info arrowed"><?php echo $summary_tag_title; ?></a>
                                                    </span>
                                                    <?php
                                                }
                                            }
                                        ...
                                        <div class="col-xs-12 title">
                                            ...
                                            <div class="tools tools-top">
                                                ...
                                                <a href="<?php echo ADMIN_URL . 'clients/edit_item/' . $item['id']; ?>" data-rel="tooltip" data-placement="bottom" title="Edit">
...
//    actions ........
                                                    function action(anchor) {
                                                        ...
                                                        if (action == 'delete')
                                                        {
                                                            ...
                                                            if (x == true)
                                                            {
                                                                $.get("<?php echo ADMIN_URL ?>views/clients/action.php?status=1&action=" + action + "&id=" + id, function(dd) {
                                                                    location.reload();
                                                                });
                                                            }
                                                        } else
                                                        ...
                                                        $('.action').click(function() {
                                                            ...
                                                            } else
                                                            {
                                                                if (action == 'delete')
                                                                {
                                                                    ...
                                                                    if (x == true)
                                                                    {
                                                                        $.get("<?php echo ADMIN_URL ?>views/clients/action.php?action=" + action + "&id=" + id, function(dd) {
                                                                            location.reload();
                                                                        });
                                                                    }
                                                                } else
