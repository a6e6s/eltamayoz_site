        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    ...
                    <a href="<?php echo ADMIN_URL; ?>quiz/new_item" class="btn btn-success col-xs-12 col-sm-2 btn-sm">New </a>
                        ...
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="center" width="10%">Questions</th>
                                    <th class="center" width="10%">Examinees</th>
                            ...
                            <tbody>
                                ...
                                if (is_array($items)) {
                                    foreach ($items as $item) {
                                        ...
                                        $count_questions = $model->Count_Rows('quiz_questions', " WHERE quiz_id = '" . $_id . "' ");  
                                        $count_examinees = $model->Count_Rows('quiz_examinees', " WHERE quiz_id = '" . $_id . "' ");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo ADMIN_URL . 'quiz/edit_item/' . $item['id']; ?>"><?php echo $title; ?></a>
                                            ...
                                            <td class="center"> <?php echo $count_questions > 0 ? ' <a href="' . ADMIN_URL . 'quiz/questions/' . $_id . '">' . $count_questions . ' Questions</a>' : ' <a href="' . ADMIN_URL . 'quiz/new_question/' . $_id . '">New Questions</a> '; ?>
                                                <td class="center"> <?php echo $count_examinees > 0 ? ' <a href="' . ADMIN_URL . 'quiz/examinees/' . $_id . '">' . $count_examinees . ' Examinees</a>' : ' --- '; ?>
                                            <td class="center">
                                                <div class="action-buttons">
                                                    ...
                                                    <a href="<?php echo ADMIN_URL . 'quiz/edit_item/' . $item['id']; ?>" data-rel="tooltip" data-placement="top" title="Edit">
...
//    actions ........
                                                function action(anchor) {
                                                    ...
                                                    if (action == 'delete')
                                                    {
                                                        ...
                                                        if (x == true)
                                                        {
                                                            $.get("<?php echo ADMIN_URL ?>views/quiz/action.php?status=1&action=" + action + "&id=" + id, function (dd) {
                                                                location.reload();
                                                            });
                                                        }
                                                    } else
                                                    ...
                                                    $('.action').click(function () {
                                                        ...
                                                        } else
                                                        {
                                                            if (action == 'delete')
                                                            {
                                                                ...
                                                                if (x == true)
                                                                {
                                                                    $.get("<?php echo ADMIN_URL ?>views/quiz/action.php?action=" + action + "&id=" + id, function (dd) {
                                                                        location.reload();
                                                                    });
                                                                }
                                                            } else
