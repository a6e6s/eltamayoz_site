...
$quiz_questions = $model->Get('quiz_questions,quiz', 'quiz_questions.id,quiz_questions.title,quiz_questions.status,quiz.title as quiz_title', " WHERE quiz_questions.quiz_id = '" . $id . "' GROUP BY quiz_questions.id  ",'quiz_questions.id');
if (!is_array($quiz)) {
    $session->message('sorry .. This page Not Found .', 'alert alert-danger');
    $model->redirect_to(ADMIN_URL . 'quiz/items');
}
$quiz_title_array = isset($quiz_questions[0]['quiz_title']) ? unserialize(base64_decode($quiz_questions[0]['quiz_title'])) : [];
?>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="<?php echo ADMIN_URL . 'quiz/items'; ?>">Quizzes</a>
                    </li>
            ...
            <div class="page-content">
                <div class="page-header">
                    <h1 class="col-xs-12 col-sm-10"> Questions of <?php echo isset($quiz_title_array['en']) ? $quiz_title_array['en'] : ''; ?> </h1>
                    <a href="<?php echo ADMIN_URL . "quiz/new_question/" . $id; ?>" class="btn btn-success col-xs-12 col-sm-2 btn-sm">New </a>
                                ...
                                if (is_array($quiz_questions)) {
                                    foreach ($quiz_questions as $item) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo ADMIN_URL . 'quiz/edit_question/' . $item['id']; ?>"><?php echo $title; ?></a>
                                            ...
                                            <td class="center">
                                                <div class="action-buttons">
                                                    ...
                                                    <a href="<?php echo ADMIN_URL . 'quiz/edit_question/' . $item['id']; ?>" data-rel="tooltip" data-placement="top" title="Edit">
...
//    actions ........
                                                        function action(anchor) {
                                                            ...
                                                            if (action == 'delete')
                                                            {
                                                                ...
                                                                if (x == true)
                                                                {
                                                                    $.get("<?php echo ADMIN_URL ?>views/quiz/question_action.php?status=1&action=" + action + "&id=" + id, function (dd) {
                                                                        location.reload();
                                                                    });
                                                                }
                                                            } else
                                                            ...
                                                            $('.action').click(function () {
                                                                ...
                                                                } else
                                                                {
                                                                    if (action == 'delete')
                                                                    {
                                                                        ...
                                                                        if (x == true)
                                                                        {
                                                                            $.get("<?php echo ADMIN_URL ?>views/quiz/question_action.php?action=" + action + "&id=" + id, function (dd) {
                                                                                location.reload();
                                                                            });
                                                                        }
                                                                    } else
