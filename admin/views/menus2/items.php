 ...
 */
$model = new model();
$where = " WHERE menus.site_id = sites.id ";
$select = "menus.id,menus.title,menus.status,menus.site_id,menus.type,menus.level,menus.menu,menus.created,menus.modified,sites.name as site_name";
$items = $model->Get('menus,sites',$select,$where);
?>
        ...
        <div class="main-content-inner">
            ...
            <div class="page-content">
                <div class="page-header">
                    <h1 class="col-xs-12 col-sm-10"> Menus
                        <small>
                            <i class="ace-icon fa fa-angle-double-right"></i>
                            List of Menus Links
                        </small>
                    </h1>
                    <a href="<?php echo ADMIN_URL; ?>menus/new_item" class="btn btn-success col-xs-12 col-sm-2 btn-sm">New </a>
                        ...
                        <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="center" width="10%">Menu</th>
                                ...
                                if (is_array($items)) {
                                    foreach ($items as $item) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo ADMIN_URL . 'menus/edit_item/' . $item['id']; ?>"><?php echo $summary_title; ?></a>
                                            ...
                                            <td class="center"><?php echo $_type; ?></td>
                                            <td class="center"><?php echo $_menu; ?></td>
                                            <td class="center">
                                                <div class="action-buttons">
                                                    ...
                                                    <a href="<?php echo ADMIN_URL . 'menus/edit_item/' . $item['id']; ?>" data-rel="tooltip" data-placement="top" title="Edit">
...
<script type="text/javascript">
                                                        ...
                                                        function action(anchor) {
                                                            ...
                                                            if (action == 'delete')
                                                            {
                                                                ...
                                                                if (x == true)
                                                                {
                                                                    $.get("<?php echo ADMIN_URL ?>views/menus/action.php?status=1&action=" + action + "&id=" + id, function(dd) {
                                                                        location.reload();
                                                                    });
                                                                }
                                                            } else
                                                            ...
                                                            $('.action').click(function() {
                                                                ...
                                                                } else
                                                                {
                                                                    if (action == 'delete')
                                                                    {
                                                                        ...
                                                                        if (x == true)
                                                                        {
                                                                            $.get("<?php echo ADMIN_URL ?>views/menus/action.php?action=" + action + "&id=" + id, function(dd) {
                                                                                location.reload();
                                                                            });
                                                                        }
                                                                    } else
