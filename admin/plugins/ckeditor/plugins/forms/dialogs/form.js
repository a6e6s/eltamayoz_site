 ...
 */
        CKEDITOR.dialog.add("form", function(a) {
            ...
            return{title: a.lang.forms.form.title, minWidth: 650, minHeight: 200, onShow: function() {
                    delete this.form;
                ...
                }, contents: [{id: "info", label: a.lang.forms.form.title, title: a.lang.forms.form.title, elements: [{id: "txtName", bidi: !0, type: "text", label: a.lang.common.name, "default": "", accessKey: "N", setup: function(a) {
