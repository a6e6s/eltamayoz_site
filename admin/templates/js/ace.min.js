...
!function() {
    ...
    function c() {
        var b = a(".sidebar");
        a.fn.ace_sidebar && b.ace_sidebar(), a.fn.ace_sidebar_scroll && b.ace_sidebar_scroll({include_toggle: !1 || ace.vars.safari || ace.vars.ios_safari}), a.fn.ace_sidebar_hover && b.ace_sidebar_hover({sub_hover_delay: 750, sub_scroll_style: "no-track scroll-thin scroll-margin scroll-visible"})
    }
    function d() {
        if (a.fn.ace_ajax) {
            window.Pace && (window.paceOptions = {ajax: !0, document: !0, eventLag: !1});
            var b = {close_active: !0, default_url: "page/index", content_url: function(a) {
                    if (!a.match(/^page\//))
                        return!1;
    ...
    function e() {
        ...
        b && a(".dropdown-content").ace_scroll({reset: !1, mouseWheelLock: !0}), b && !ace.vars.old_ie && (a(window).on("resize.reset_scroll", function() {
    ...
    function f() {
        a(document).on("click.dropdown.pos", '.dropdown-toggle[data-position="auto"]', function() {
            var b = a(this).offset(), c = a(this.parentNode);
    ...
    function g() {
        a('.ace-nav [class*="icon-animated-"]').closest("a").one("click", function() {
            var b = a(this).find('[class*="icon-animated-"]').eq(0), c = b.attr("class").match(/icon\-animated\-([\d\w]+)/);
            b.removeClass(c[0])
    ...
    function h() {
        a(".sidebar .nav-list .badge[title],.sidebar .nav-list .badge[title]").each(function() {
            ...
            b = b ? b[0] : "tooltip-error", a(this).tooltip({placement: function(b, c) {
                    var d = a(c).offset();
                    return parseInt(d.left) < parseInt(document.body.scrollWidth / 2) ? "right" : "left"
                }, container: "body", template: '<div class="tooltip ' + b + '"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>'})
        })
    }
    function i() {
        ...
        if (b.length > 0) {
            ...
            a(window).on("scroll.scroll_btn", function() {
                var a = ace.helper.scrollTop(), d = ace.helper.winHeight(), e = document.body.scrollHeight;
    ...
    function l() {
        function b() {
            ...
            if ("fixed" == b.css("position")) {
                var d = parseInt(a(window).width()), e = d > 320 ? 60 : d > 240 ? 40 : 30, f = parseInt(d) - e, g = parseInt(a(window).height()) - 30, h = parseInt(Math.min(f, 320));
                b.css("width", h);
                ...
                var p = parseInt(Math.min(g, 480, m + j)), q = parseInt(Math.abs((f + e - h) / 2)), r = parseInt(Math.abs((g + 30 - p) / 2)), s = parseInt(b.css("z-index")) || 0;
                if (b.css({height: p, left: q, right: "auto", top: r - (i ? 3 : 1)}), 1 == k.length && (ace.vars.touch ? k.ace_scroll("disable").css("max-height", p - j).addClass("overflow-scroll") : k.ace_scroll("update", {size: p - j}).ace_scroll("enable").ace_scroll("reset")), b.css("height", p + (i ? 7 : 2)), b.hasClass("user-menu")) {
                    b.css("height", "");
                    var t = a(this).find(".user-info");
                    t.css(1 == t.length && "fixed" == t.css("position") ? {left: q, right: "auto", top: r, width: h - 2, "max-width": h - 2, "z-index": s + 1} : {left: "", right: "", top: "", width: "", "max-width": "", "z-index": ""})
                }
                a(this).closest(".navbar.navbar-fixed-top").css("z-index", s)
            } else
                0 != b.length && c.call(this, b);
            var u = this;
        ...
        function c(b) {
            if (b = b || a(this).find("> .dropdown-menu"), b.length > 0 && (b.css({width: "", height: "", left: "", right: "", top: ""}).find(".dropdown-content").each(function() {
    ...
    a.unCamelCase = function(a) {
        ...
        var b = a.match(/^(?:(true)|(false)|(null)|(\-?[\d]+(?:\.[\d]+)?)|(\[.*\]|\{.*\}))$/i), c = a;
        if (b)
            if (b[1])
                c = !0;
            else if (b[2])
        ...
        var e = c instanceof Array ? 1 : 2, d = d ? d.replace(/([^\-])$/, "$1-") : "";
        d = "data-" + d;
        var f = {};
        for (var g in c)
    ...
    function c(b, c) {
        ...
        function f(b) {
            ...
            if (c.length > 0)
                document.title = c.text(), c.remove();
            else if (b.length > 0) {
        ...
        this.force_reload = !1, this.loadUrl = function(a, b) {
            ...
            if (!j) {
                var i;
                g.trigger(i = a.Event("ajaxloadstart"), {url: b, hash: c}), i.isDefaultPrevented() || (h.startLoading(), a.ajax({url: b, cache: !this.force_reload}).error(function() {
                    g.trigger("ajaxloaderror", {url: b, hash: c}), h.stopLoading(!0)
                }).done(function(i) {
                    g.trigger("ajaxloaddone", {url: b, hash: c});
                    var j = null, l = "";
                    if ("function" == typeof h.settings.update_active)
                        j = h.settings.update_active.call(null, c, b);
                    ...
                    "function" == typeof h.settings.update_breadcrumbs ? l = h.settings.update_breadcrumbs.call(null, c, b, j) : h.settings.update_breadcrumbs === !0 && null != j && j.length > 0 && (l = e(j)), i = String(i).replace(/<(title|link)([\s\>])/gi, '<div class="hidden ajax-append-$1"$2').replace(/<\/(title|link)\>/gi, "</div>"), k.addClass("content-loaded").detach(), g.empty().html(i), a(h.settings.loading_overlay || g).append(k), setTimeout(function() {
                        ...
                        g.find(".ajax-append-link").each(function() {
                            var b = a(this);
                            if (b.attr("href")) {
                                var d = jQuery("<link />", {type: "text/css", rel: "stylesheet", "class": "ace-ajax-stylesheet"});
                                c.length > 0 ? d.insertBefore(c) : d.appendTo("head"), d.attr("href", b.attr("href"))
                            }
                            b.remove()
                        })
                    }, 10), "function" == typeof h.settings.update_title ? h.settings.update_title.call(null, c, b, l) : h.settings.update_title === !0 && f(l), d || a("html,body").animate({scrollTop: 0}, 250), g.trigger("ajaxloadcomplete", {url: b, hash: c}), h.stopLoading()
                }))
            }
        };
        var l = !1, m = null;
    ...
    a.fn.aceAjax = a.fn.ace_ajax = function(d, e, f, g) {
        var h, i = this.each(function() {
            var i = a(this), j = i.data("ace_ajax"), k = "object" == typeof d && d;
            j || i.data("ace_ajax", j = new c(this, k)), "string" == typeof d && "function" == typeof j[d] && (h = g != b ? j[d](e, f, g) : f != b ? j[d](e, f) : j[d](e))
        });
        return h === b ? i : h
    }, a.fn.aceAjax.defaults = a.fn.ace_ajax.defaults = {content_url: !1, default_url: !1, loading_icon: "fa fa-spin fa-spinner fa-2x orange", loading_text: "", loading_overlay: null, update_breadcrumbs: !0, update_title: !0, update_active: !0, close_active: !1, max_load_wait: !1}
}(window.jQuery), function(a, b) {
    if (ace.vars.touch) {
        var c = "touchstart MSPointerDown pointerdown", d = "touchend touchcancel MSPointerUp MSPointerCancel pointerup pointercancel", e = "touchmove MSPointerMove MSPointerHover pointermove";
        a.event.special.ace_drag = {setup: function() {
                var f = 0, g = a(this);
                g.on(c, function(c) {
                    function h(a) {
                        if (k) {
                            var b = a.originalEvent.touches ? a.originalEvent.touches[0] : a;
                            if (i = {coords: [b.pageX, b.pageY]}, k && i && (m = 0, n = 0, l = Math.abs(n = k.coords[1] - i.coords[1]) > f && Math.abs(m = k.coords[0] - i.coords[0]) <= Math.abs(n) ? n > 0 ? "up" : "down" : Math.abs(m = k.coords[0] - i.coords[0]) > f && Math.abs(n) <= Math.abs(m) ? m > 0 ? "left" : "right" : !1, l !== !1)) {
                                var c = {cancel: !1};
                    ...
                    var i, j = c.originalEvent.touches ? c.originalEvent.touches[0] : c, k = {coords: [j.pageX, j.pageY], origin: a(c.target)}, l = !1, m = 0, n = 0;
    ...
    function c(c, e) {
        ...
        this.toggleMenu = function(a, b) {
            ...
            var c = this, d = a(b.target).closest("a");
            if (d && 0 != d.length) {
                ...
                if (d.hasClass("dropdown-toggle")) {
                    ...
                    if (!f)
                        return!1;
                    var h = a(f), i = 0, j = f.parentNode.parentNode;
                    if (e && j == c || h.parent().hasClass("hover") && "absolute" == h.css("position") && !g.collapsible)
                        return!1;
                ...
                if (ace.vars.ios_safari && "false" !== d.attr("data-link"))
                    return document.location = d.attr("href"), b.preventDefault(), !1
            }
        });
        var k = !1;
        this.show = function(b, c, d) {
            if (d = d !== !1, d && k)
                return!1;
            var e, f = a(b);
            if (f.trigger(e = a.Event("show.ace.submenu")), e.isDefaultPrevented())
                return!1;
            d && (k = !0), c = c || this.settings.duration, f.css({height: 0, overflow: "hidden", display: "block"}).removeClass("nav-hide").addClass("nav-show").parent().addClass("open"), b.scrollTop = 0, c > 0 && f.css({height: b.scrollHeight, "transition-property": "height", "transition-duration": c / 1e3 + "s"});
            var g = function(b, c) {
                b && b.stopPropagation(), f.css({"transition-property": "", "transition-duration": "", overflow: "", height: ""}), c !== !1 && f.trigger(a.Event("shown.ace.submenu")), d && (k = !1)
            };
            ...
            if (d = d !== !1, d && k)
                return!1;
            var e, f = a(b);
            if (f.trigger(e = a.Event("hide.ace.submenu")), e.isDefaultPrevented())
                return!1;
            d && (k = !0), c = c || this.settings.duration, f.css({height: b.scrollHeight, overflow: "hidden", display: "block"}).parent().removeClass("open"), b.offsetHeight, c > 0 && f.css({height: 0, "transition-property": "height", "transition-duration": c / 1e3 + "s"});
            var g = function(b, c) {
                b && b.stopPropagation(), f.css({display: "none", overflow: "", height: "", "transition-property": "", "transition-duration": ""}).removeClass("nav-show").addClass("nav-hide"), c !== !1 && f.trigger(a.Event("hidden.ace.submenu")), d && (k = !1)
            };
            return c > 0 && a.support.transition.end ? f.one(a.support.transition.end, g) : g(), ace.vars.android && setTimeout(function() {
                g(null, !1), ace.helper.redraw(b)
            }, c + 20), !0
        ...
        var l = "menu-min", m = "responsive-min", n = "h-sidebar", o = function() {
    ...
    a(document).on(ace.click_event + ".ace.menu", ".menu-toggler", function(b) {
        ...
        if (0 != d.length) {
            ...
            var e = ace.click_event + ".ace.autohide", f = "true" === d.attr("data-auto-hide");
        ...
        var c = a(this).attr("data-target"), d = null;
        ...
        var f, g = this.each(function() {
            var b = a(this), g = b.data("ace_sidebar"), h = "object" == typeof d && d;
            g || b.data("ace_sidebar", g = new c(this, h)), "string" == typeof d && "function" == typeof g[d] && (f = e instanceof Array ? g[d].apply(g, e) : g[d](e))
        });
        return f === b ? g : f
    }, a.fn.ace_sidebar.defaults = {duration: 300}
}(window.jQuery), function(a, b) {
    function c(b, c) {
        var f = this, g = a(window), h = a(b), i = h.find(".nav-list"), j = h.find(".sidebar-toggle").eq(0), k = h.find(".sidebar-shortcuts").eq(0), l = i.get(0);
        if (l) {
            ...
            var n = f.settings.scroll_to_active, o = h.ace_sidebar("ref");
            h.attr("data-sidebar-scroll", "true");
            var p = null, q = null, r = null, s = null, t = null, u = null;
            this.is_scrolling = !1;
            var v = !1;
            ...
            var w, x, y = function() {
                ...
                if (!v && f.sidebar_fixed) {
                    i.wrap('<div class="nav-wrap-up pos-rel" />'), i.after("<div><div></div></div>"), i.wrap('<div class="nav-wrap" />'), f.settings.include_toggle || j.css({"z-index": 1}), f.settings.include_shortcuts || k.css({"z-index": 99}), p = i.parent().next().ace_scroll({size: y(), mouseWheelLock: !0, hoverReset: !1, dragEvent: !0, styleClass: f.settings.scroll_style, touchDrag: !1}).closest(".ace-scroll").addClass("nav-scroll"), u = p.data("ace_scroll"), q = p.find(".scroll-content").eq(0), r = q.find(" > div").eq(0), t = a(u.get_track()), s = t.find(".scroll-bar").eq(0), f.settings.include_shortcuts && 0 != k.length && (i.parent().prepend(k).wrapInner("<div />"), i = i.parent()), f.settings.include_toggle && 0 != j.length && (i.append(j), i.closest(".nav-wrap").addClass("nav-wrap-t")), i.css({position: "relative"}), 1 == f.settings.scroll_outside && p.addClass("scrollout"), l = i.get(0), l.style.top = 0, q.on("scroll.nav", function() {
                    ...
                    if (i.on("ace_drag.nav", function(b) {
                        if (!f.is_scrolling || !u.is_active())
                            return void(b.retval.cancel = !0);
                        if (0 != a(b.target).closest(".can-scroll").length)
                            return void(b.retval.cancel = !0);
                    ...
                    if (v = !0, 1 == b && (f.reset(), n && f.scroll_to_active(), n = !1), "number" == typeof f.settings.smooth_scroll && f.settings.smooth_scroll > 0 && (i.css({"transition-property": "top", "transition-duration": (f.settings.smooth_scroll / 1e3).toFixed(2) + "s"}), s.css({"transition-property": "top", "transition-duration": (f.settings.smooth_scroll / 1500).toFixed(2) + "s"}), p.on("drag.start", function(a) {
            ...
            this.scroll_to_active = function() {
                if (u && u.is_active())
                    try {
                        var a, b = o.vars(), c = h.find(".nav-list");
                ...
                if (a === !0 && (this.sidebar_fixed = e(b, "fixed")), !this.sidebar_fixed)
                    return void this.disable();
                v || A();
                var c = o.vars(), d = !c.collapsible && !c.horizontal && (w = y()) < (x = l.clientHeight);
                this.is_scrolling = !0, d && (r.css({height: x, width: 8}), p.prev().css({"max-height": w}), u.update({size: w}), u.enable(), u.reset()), d && u.is_active() ? h.addClass("sidebar-scroll") : this.is_scrolling && this.disable()
            }, this.disable = function() {
                this.is_scrolling = !1, p && (p.css({height: "", "max-height": ""}), r.css({height: "", width: ""}), p.prev().css({"max-height": ""}), u.disable()), parseInt(l.style.top) < 0 && f.settings.smooth_scroll && a.support.transition.end ? i.one(a.support.transition.end, function() {
    ...
    var d = ace.vars.safari && navigator.userAgent.match(/version\/[1-5]/i), e = "getComputedStyle"in window ? function(a, b) {
    ...
    a(document).on("settings.ace.sidebar_scroll", function(b, c) {
        a(".sidebar[data-sidebar-scroll=true]").each(function() {
            var b = a(this), d = b.ace_sidebar_scroll("ref");
            if ("sidebar_collapsed" == c && e(this, "fixed"))
                "true" == b.attr("data-sidebar-hover") && b.ace_sidebar_hover("reset"), d._reset();
            else if ("sidebar_fixed" === c || "navbar_fixed" === c) {
                var f = d.get("is_scrolling"), g = e(this, "fixed");
        ...
        a(".sidebar[data-sidebar-scroll=true]").each(function() {
            ...
            var c = a(this).ace_sidebar_scroll("ref"), d = e(this, "fixed");
            c.set("sidebar_fixed", d), c._reset()
        })
    }), a.fn.ace_sidebar_scroll || (a.fn.ace_sidebar_scroll = function(d, e) {
        var f, g = this.each(function() {
            var b = a(this), g = b.data("ace_sidebar_scroll"), h = "object" == typeof d && d;
    ...
    function c(b, c) {
        ...
        function k(c) {
            ...
            var h = ace.helper.scrollTop(), i = 0, k = h;
            v && (i = b.offsetTop, k += i + 1);
            var m = d.offset();
            m.top = parseInt(m.top);
            var n, o = 0;
            c.style.maxHeight = "";
            var r = c.scrollHeight, n = d.height();
            g && (o = n, m.top += o);
            var u = parseInt(m.top + r), x = 0, y = t.height(), z = parseInt(m.top - k - o), A = y, B = q.horizontal, C = !1;
        ...
        var l = this, m = this, n = ace.helper.getAttrSettings(b, a.fn.ace_sidebar_hover.defaults);
        this.settings = a.extend({}, a.fn.ace_sidebar_hover.defaults, c, n);
        var o = a(b), p = o.find(".nav-list").get(0);
        o.attr("data-sidebar-hover", "true"), g.push(o);
        var q = {}, r = ace.vars.old_ie, s = !1;
        d && (l.settings.sub_hover_delay = parseInt(Math.max(l.settings.sub_hover_delay, 2500)));
        var t = a(window), u = a(".navbar").eq(0), v = "fixed" == u.css("position");
        this.update_vars = function() {
            ...
            0 != l.dirty && (l.dirty = !1, o.find(".submenu").each(function() {
                ...
                b.css({top: "", bottom: "", "max-height": ""}), b.hasClass("ace-scroll") ? b.ace_scroll("disable") : b.removeClass("sub-scroll"), f(this, "absolute") ? b.addClass("can-scroll") : b.removeClass("can-scroll"), c.removeClass("pull_up").find(".menu-text:first").css("margin-top", "")
        ...
        var x = -1, y = d ? "touchstart.sub_hover" : "mouseenter.sub_hover", z = d ? "touchend.sub_hover touchcancel.sub_hover" : "mouseleave.sub_hover";
        o.on(y, ".nav-list li, .sidebar-shortcuts", function() {
            if (q = o.ace_sidebar("vars"), !q.collapsible) {
                var b = a(this), c = !1, e = b.hasClass("hover"), g = b.find("> .submenu").get(0);
                if (!(g || this.parentNode == p || e || (c = b.hasClass("sidebar-shortcuts"))))
                    return void(g && a(g).removeClass("can-scroll"));
                var h = g, j = !1;
                if (h || this.parentNode != p || (h = b.find("> a > .menu-text").get(0)), !h && c && (h = b.find(".sidebar-shortcuts-large").get(0)), !(h && (j = f(h, "absolute")) || e))
                    return void(g && a(g).removeClass("can-scroll"));
                var m = i(this);
                if (g)
                    if (j) {
    ...
    if (!ace.vars.very_old_ie) {
        var d = ace.vars.touch, e = ace.vars.old_ie || d, f = "getComputedStyle"in window ? function(a, b) {
            return a.offsetHeight, window.getComputedStyle(a).position == b
        } : function(b, c) {
            return b.offsetHeight, a(b).css("position") == c
        };
        ...
        a.fn.ace_sidebar_hover = function(d, e) {
            var f, g = this.each(function() {
                var b = a(this), g = b.data("ace_sidebar_hover"), h = "object" == typeof d && d;
                g || b.data("ace_sidebar_hover", g = new c(this, h)), "string" == typeof d && "function" == typeof g[d] && (f = g[d](e))
            });
            return f === b ? g : f
        }, a.fn.ace_sidebar_hover.defaults = {sub_sub_hover_delay: 750, sub_scroll_style: "no-track scroll-thin"}
    }
}(window.jQuery), function(a, b) {
    function c(b, c) {
        ...
        if (c) {
            ...
            g = parseInt(g), d.css("min-height", g), e ? (f && d.ace_scroll("disable"), d.css("max-height", g).addClass("overflow-scroll")) : (f ? d.ace_scroll("update", {size: g, mouseWheelLock: !0, lockAnyway: !0}) : d.ace_scroll({size: g, mouseWheelLock: !0, lockAnyway: !0}), d.ace_scroll("enable").ace_scroll("reset")), a(window).on("resize.widget.scroll", function() {
            ...
            h && d.ace_scroll("update", {size: h.size, mouseWheelLock: h.lock, lockAnyway: h.lock_anyway}).ace_scroll("enable").ace_scroll("reset"), e ? d.css("max-height", "").removeClass("overflow-scroll") : h || d.ace_scroll("disable")
        }
    }
    var d = function(b) {
        this.$box = a(b);
        this.reload = function() {
            ...
            var a = this.$box, b = 300;
            a.fadeOut(b, function() {
                a.trigger("closed.ace.widget"), a.remove()
            })
        }, this.toggle = function(a, b) {
            var c = this.$box, d = c.find(".widget-body").eq(0), e = null, f = "undefined" != typeof a ? a : c.hasClass("collapsed") ? "show" : "hide", g = "show" == f ? "shown" : "hidden";
            ...
            var a = this.$box.find("> .widget-header a[data-action=fullscreen]").find(ace.vars[".icon"]).eq(0), b = null, d = null;
    ...
    a.fn.widget_box = function(c, e) {
        var f, g = this.each(function() {
            var b = a(this), g = b.data("widget_box"), h = "object" == typeof c && c;
        ...
        b.preventDefault();
        var c = a(this), e = c.closest(".widget-box");
    ...
    a("#ace-settings-btn").on(ace.click_event, function(b) {
        ...
        if (this.checked) {
            ...
            a("#sidebar").removeClass("compact"), a("#sidebar[data-sidebar-scroll=true]").ace_sidebar_scroll("reset");
        ...
        if (!a("#sidebar").hasClass("h-sidebar")) {
            if (this.checked)
                a("#sidebar li").addClass("hover").filter(".open").removeClass("open").find("> .submenu").css("display", "none");
            else {
    ...
    var b = function() {
        ...
        if (0 == a("#ace-rtl-stylesheet").length) {
            ...
            var d = a("head").find("link#ace-skins-stylesheet"), e = c.first().attr("href").replace(/(\.min)?\.css$/i, "-rtl$1.css");
            a.ajax({url: e}).done(function() {
                var a = jQuery("<link />", {type: "text/css", rel: "stylesheet", id: "ace-rtl-stylesheet"});
    ...
    a("#skin-colorpicker").on("change", function() {
        ...
        if (0 == a("#ace-skins-stylesheet").length) {
            ...
            a.ajax({url: e}).done(function() {
                var a = jQuery("<link />", {type: "text/css", rel: "stylesheet", id: "ace-skins-stylesheet"});
    ...
    try {
        a("#nav-search-input").bs_typeahead({source: ace.vars.US_STATES, updater: function(b) {
