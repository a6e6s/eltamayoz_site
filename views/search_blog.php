...
<div id="page-content">
    ...
    <section class="row header-page" id="header-page">
        ...
        <div class="container">
            <div class="head-con">
                <div class="heading2">
                    <h1 class="wow zoomIn" data-wow-delay=".5s"><?php echo $language->Search_Blog; ?></h1>
...
//            pagination .....
                if ($total_pages > 1) {
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 end-lists">
                        <ul class="pagination">
                            <?php
                            $pag_url = URL . $_SESSION['language_alias'] . '/blog/search/'.$alias.'/';
...
<!--End page-content-->
<script type="text/javascript" src="//s3.amazonaws.com/downloads.mailchimp.com/js/signup-forms/popup/embed.js" data-dojo-config="usePlainJson: true, isDebug: false"></script><script type="text/javascript">require(["mojo/signup-forms/Loader"], function(L) { L.start({"baseUrl":"mc.us14.list-manage.com","uuid":"2e2ff06a0d723fdea7f2c50db","lid":"154e0e294c"}) })</script>
